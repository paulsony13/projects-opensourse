                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content all-icons">
                                ...
                                <a href="../tbl_item/form.php">    <div class="font-icon-detail"><i class="pe-7s-ticket"></i>
                                      <input type="text" value="ITEMS">
                                    </div></a>
                                  </div>   
 
                                  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                <a href="../tbl_order/form1.php">    <div class="font-icon-detail"><i class="pe-7s-cart"></i>
                                ...
                                <a href="../tbl_userpreference/select.php">    <div class="font-icon-detail"><i class="pe-7s-upload"></i>
                                      <input type="text" value="USER PREFERENCE">
                                    </div></a>
                                  </div>
