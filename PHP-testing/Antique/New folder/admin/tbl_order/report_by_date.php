...
<thead>
	<h2>
		<center>
			<img src="../common/header.png" width="100%">Sales Report of <?php echo $_REQUEST['d1']?>
		</center>
	</h2>
</thead>
...
$result2 = mysqli_query($con,"SHOW FIELDS FROM tbl_order_master");
...
if(isset($_REQUEST['d1']))
{
	...
	$tot = 0;
	$results = mysqli_query($con,"SELECT om.cust_id, oc.item_id, oc.o_qty, oc.price, om.o_date FROM tbl_order_master om inner join tbl_order_child oc on om.id = oc.om_id WHERE om.o_date = '$_REQUEST[d1]' AND om.status='PURCHASED' "); 
	$sl=1;
