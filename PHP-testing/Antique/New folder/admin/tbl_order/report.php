...
<h2>
	<center>
		<img src="../common/header.png" width="100%">Sales Report  <?php echo $_REQUEST['d1']." to " . $_REQUEST['d2']?>
	</center>
</h2>
</thead>
...
$results = mysqli_query($con,"SELECT om.cust_id, oc.item_id, oc.o_qty, oc.price, om.o_date FROM tbl_order_master om inner join tbl_order_child oc on om.id = oc.om_id 
										  WHERE om.status='PURCHASED' AND om.o_date BETWEEN '$_REQUEST[d1]' AND '$_REQUEST[d2]' "); 
