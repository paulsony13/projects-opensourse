...
elseif($i==70)
{
	...
	echo "<input type='hidden' name='$name' value='$_SESSION[userid]' class='form-control' required >";
}
elseif($i==60)
{
	$dateT=date("Y-m-d H:i:s");
	echo "<input type='hidden' name='$name' value='$dateT' class='form-control' required >";
}
