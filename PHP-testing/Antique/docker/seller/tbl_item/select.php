...
<h1><center>ITEM DETAILS</center></h1>
...
<?php
	...
	echo "<div class='col-sm-2' style='float:right;margin-bottom:10px;'><form action='report.php' method='post'><input type='submit' name='view' value='Report' class='form-control btn-primary'></form></div>";
?>
 ...
 <th>Del</th> 
  ...
  // $i=0;
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM $table WHERE sid='$_SESSION[sid]'");
		...
		for($k=0;$k<$i;$k++)
		{
			...
			if($k==1)
			{
			  $sql2 = "select *  from tbl_seller where id='$row[sid]' ";
			...
			echo "<td > <img src='../../admin/tbl_item/uploads/$row[$k]' width='100'></td>";
