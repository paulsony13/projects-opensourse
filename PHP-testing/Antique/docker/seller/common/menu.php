...
<div class="sidebar" data-color="yh">
    	...
    	<div class="sidebar-wrapper">
            ...
            <br/> <br/>
               ...
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/logo.png" width="180"></a> 
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="../tbl_userpreference/select.php">
                        <i class="pe-7s-angle-right-circle"></i>
                        <p>USER PREFERENCE</p>
                    </a>
                </li>
...
<marquee width="100%" direction="left" height="50%" behavior="scroll">
  <font face="Trebuchet MS, Arial, Helvetica, sans-serif" size="+3" color="#fbb808">  <font color="#000000">Welcome </font>You <font color="#000000">To</font> Antique<font color="#000000"> Shop</font></font>
</marquee>
