...
?>
<?php
$sel="select * from tbl_customer where c_id='".$_SESSION["cid"]."'";
$row=mysql_query($sel);
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style28">
                             <input type="text "runat="server" ForeColor="#33CC33" style="font-weight: 700"value="<?php echo  "Bizzy Ladies Boutique";?>"/>
